      ...
      <div className="bg-neutral-900 lg:p-20 py-20 px-10 font-manrope">
        ...
        {selectedLanguage === "French" && (
          <div className="flex flex-col font-bold">
            <span className="bg-gradient-to-r from-amber-600 via-amber-700 to-pink-700 text-transparent bg-clip-text text-xl font-bold lg:text-center text-left font-manrope font-bold">
              Fonctionnalités de l'application
            </span>
            <p className="text-white  text-4xl lg:text-6xl lg:text-center text-left mt-5 font-manrope font-bold">
